...
Each entry maps a canonical tag -> (weight, list of match phrases). Weights are
relative; the scorer normalizes the summed weight of matched groups to 0–100.
...
# tag: (penalty_points, phrases). Penalty is subtracted from the FINAL score.
